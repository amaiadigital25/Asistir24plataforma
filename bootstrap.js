...
function loadServerWithRuntimeFixes() {
  ...
  if (start !== -1 && end !== -1 && end > start) {
    const replacement = [
      ...
      '    datosMail: { vehiculo: parsed.vehiculo || "", marca: parsed.marca || "", modelo: parsed.modelo || "", color: parsed.color || "", fechaServicio: parsed.fechaServicio || "", condicionServicio: parsed.condicionServicio || "", transmision: parsed.transmision || "", especificaciones: parsed.especificaciones || "", personasTrasladar: parsed.personasTrasladar || "", siniestro: parsed.siniestro || "", enCochera: parsed.enCochera || "", poseeCarga: parsed.poseeCarga || "", vehiculoRueda: parsed.vehiculoRueda || "", tieneTrailer: parsed.tieneTrailer || "", requiereExtraccion: parsed.requiereExtraccion || "", informacionTecnica: parsed.informacionTecnica || "", observaciones: parsed.observaciones || "", asegurado: parsed.asegurado || "", telefono: parsed.telefono || "", emailAsegurado: parsed.emailAsegurado || "" },',
      ...
      '  };',
      '',
      '  q.remito = { ...buildRemito(q), independienteCalculo: true };',
      '',
