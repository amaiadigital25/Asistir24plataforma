...
function loadServerWithRuntimeFixes() {
  ...
  if (start !== -1 && end !== -1 && end > start) {
    const replacement = [
      ...
      '    datosMail: { vehiculo: parsed.vehiculo || "", marca: parsed.marca || "", modelo: parsed.modelo || "", color: parsed.color || "", observaciones: parsed.observaciones || "", asegurado: parsed.asegurado || "", telefono: parsed.telefono || "", emailAsegurado: parsed.emailAsegurado || "" },',
      ...
      '    "Patente: " + (q.patente || "-"),',
      '    "Marca: " + (d.marca || "-"),',
      '    "Modelo: " + (d.modelo || d.vehiculo || "-"),',
      '    "Color: " + (d.color || "-"),',
      '    "Asegurado: " + (d.asegurado || "-"),',
      '    "Teléfono: " + (d.telefono || "-"),',
      '    "Correo: " + (d.emailAsegurado || "-"),',
      '    "Origen / punto de encuentro: " + (q.origen || "-"),',
      '    ...(q.destino ? ["Destino: " + q.destino] : []),',
      '    "Observaciones: " + (d.observaciones || "-")',
      '  ];',
      '  q.remito = { version: 3, preparadoAt: fecha, incluyeImportes: false, independienteCalculo: true, texto: remitoLines.join("\\n") };',
      '',
